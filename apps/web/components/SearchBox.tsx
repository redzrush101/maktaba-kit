export function SearchBox({ defaultValue = "", action = "/search", placeholder = "ابحث في المكتبات...", hiddenFields = {}, defaultSource = "all" }: { defaultValue?: string; action?: string; placeholder?: string; hiddenFields?: Record<string, string | undefined>; defaultSource?: string }) {
  return (
